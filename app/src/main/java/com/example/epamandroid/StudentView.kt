...
//    }
    ...
    fun sethwCount(count: String): StudentView {
        student_view_student_name_textView.text = count
        return this
    }
    fun isStudent(isStudent: Boolean): StudentView {
        when{
            isStudent -> student_view_is_student_icon.visibility = View.VISIBLE
            !isStudent -> student_view_expelled_icon.visibility = View.VISIBLE
        }
        return this
    }

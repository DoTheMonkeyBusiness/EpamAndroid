...
object DatabaseConstants {
    object RestaurantTypesTable : BaseColumns {
        const val TABLE_NAME_RESTAURANT_TYPES_TABLE_EXTRA_KEY: String = "RestaurantTypesTable"
        const val COLUMN_NAME_RESTAURANT_ID_EXTRA_KEY: String = "restaurantId"
        const val COLUMN_NAME_TYPE_EXTRA_KEY: String = "type"
        ...
        const val COLUMN_NAME_TYPE_POPULARITY_EXTRA_KEY: String = "typePopularity"
        ...
        const val COLUMN_INDEX_RESTAURANT_ID_EXTRA_KEY: Int = 1
        const val COLUMN_INDEX_TYPE_EXTRA_KEY: Int = 2
        ...
        const val COLUMN_INDEX_TYPE_POPULARITY_EXTRA_KEY: Int = 8
    ...
    object RestaurantTypesTrigger {
        const val TRIGGER_NAME_RESTAURANT_TYPES_TRIGGER_EXTRA_KEY: String = "RestaurantTypesTrigger"

    }

    object SqlStrings {
        const val SELECT_ALL_RESTAURANTS_SQL_STRING_EXTRA_KEY: String = "SELECT * FROM $TABLE_NAME_RESTAURANT_TYPES_TABLE_EXTRA_KEY"
        const val SELECT_LAST_INSERT_TIME_SQL_STRING_EXTRA_KEY: String = "SELECT * FROM" +
                SPACE_EXTRA_KEY +
                TABLE_NAME_LAST_MODIFICATION_TABLE_EXTRA_KEY
        const val SELECT_RESTAURANT_BY_TYPE_SQL_STRING_EXTRA_KEY: String = "SELECT * FROM" +
                SPACE_EXTRA_KEY +
                TABLE_NAME_RESTAURANT_TYPES_TABLE_EXTRA_KEY +
                SPACE_EXTRA_KEY +
                "WHERE" +
                SPACE_EXTRA_KEY +
                COLUMN_NAME_TYPE_EXTRA_KEY +
                SPACE_EXTRA_KEY +
